-- 87_jobs_add_export_suppleringer.sql
-- Update job types constraint to include export_suppleringer

-- Drop the existing constraint
alter table public.jobs 
  drop constraint if exists jobs_type_check;

-- Add comprehensive constraint with all job types including export_suppleringer
alter table public.jobs 
